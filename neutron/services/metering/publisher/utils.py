...
OPTS = [
    ...
    cfg.BoolOpt('shrink_metadata',
                default=False,
                help='Shrink resource_metadata of sample or not.',
                ),
]
...
def meter_message_from_sample(sample, shrink_metadata=False):
    ...
    msg = {'source': sample['source'],
           ...
           'resource_metadata': ({} if shrink_metadata
                                 else sample['resource_metadata']),
